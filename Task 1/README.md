...
1. Clone this repository:
   ...
   cd AI-ML-Internship-Task/Task 1
   ```
...
* **`iris_box_plots.png`** *(Focus Feature)*: A comprehensive box plot comparing numerical variables across species to flag data variance and outliers.
...
* Advanced charting aesthetics and visualization design with **Seaborn** & **Matplotlib**
